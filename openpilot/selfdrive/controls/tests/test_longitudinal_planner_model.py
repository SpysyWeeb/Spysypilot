...
class TestLongitudinalPlannerModel(OpenpilotTestCase):
  def test_parse_model_preserves_custom_launch_inputs(self):
    model = model_message()
  ...
  def test_parse_model_falls_back_safely_on_invalid_trajectory(self):
