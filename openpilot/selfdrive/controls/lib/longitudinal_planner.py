...
from openpilot.selfdrive.controls.lib.longitudinal_mpc_lib.long_mpc import (COMFORT_BRAKE, LEAD_ABSENCE_FRAMES, LongitudinalMpc,
                                                                          LongitudinalPlanSource, STOP_DISTANCE, get_T_FOLLOW)
...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    # all three launch sources release the landing on the same frame: the lead-departure pre-release (a corroborated departure
    # or its hold handed back), a Force Stops release and the green-light anticipation opening
