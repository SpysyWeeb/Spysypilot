...
**Status: phase 1 field-validated 2026-08-29; phase 2 steps 2 and 3 merged and field-validated 2026-08-29 — step 3
(modeld's curvature preview is the rack path; the immediate target is the scalar itself) drove clean on route 00000024,
and the path-compile cost fix (`RackTrajectoryController.update` 4.0 → 1.75 ms per frame) took controlsd from 36 % to
25 % of its core with zero skipped control frames.** `controlsd`
