...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — future-path, actuator-aware Hyundai torque control with (409, 4, 7) command/safety limits, post-stall EPS breakaway relief, a committed-handoff cap, and an in-progress low-speed/high-angle unwind exit that removes stale old-direction command toward crown-neutral; pending field validation &nbsp;*(personal idea)*
