...
- ⚠️ **[Better lateral tune v2 (BLaTv2)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaTv2)** — v217 uses one scalar-faithful inverse-EPS command path: measured rack dynamics, calm small-error stiffness, and one continuous authority curve provide smooth full-torque tracking without preview boosts, persistence gates, or low-speed mode switches; four-route delivered replay passes all five against v14, and field validation remains in progress; passive frozen-v14 shadow v13 provides the live A/B &nbsp;*(personal idea)*
