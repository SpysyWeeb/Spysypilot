...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — future-path, actuator-aware Hyundai torque control with (409, 4, 7) command/safety limits, post-stall EPS breakaway relief, a committed-handoff cap, and controller v17's in-progress monotonic high-angle release plus guarded, bounded EPS breakout assist; route-94 replay passed and field validation is pending &nbsp;*(personal idea)*
