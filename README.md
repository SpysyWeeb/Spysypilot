...
- ⚠️ **[Comma 3X spinning steering wheel](https://github.com/SpysyWeeb/Spysypilot/tree/spinning-steering-wheel)** — shows the comma four bottom-left wheel indicator by default on the comma 3X onroad display; it rotates with measured steering angle and fades with engagement &nbsp;*(inspired by comma four)*
