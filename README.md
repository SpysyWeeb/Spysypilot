...
- ⚠️ **[Better lateral tune v2 (BLaTv2)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaTv2)** — v221 preserves v220's scalar-faithful inverse-EPS steering law while removing redundant terminal, delay, reference, and horizon work that reduced the c9 control loop to about 69 Hz and stretched Hyundai's unchanged high-angle protection long enough to trigger temporary EPS refusals; the 85-degree/89-frame protection, 409/4/7 envelope, path timing, gains, torque authority, and fault alerts are unchanged, and field validation remains in progress &nbsp;*(personal idea)*
