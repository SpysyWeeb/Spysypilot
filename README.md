...
⚠️ 2026-09-24: synced with upstream master afa47035b (precompiled Chestnut warps, 100 W GPU power limit, realtime scheduling after the model load, big-model fallback fix, Tesla/Rivian car changes); combo keeps its opendbc/panda pins; c3x-chestnut-v2 resolved the modeld conflict and adds the permanent 'Big Model Loading' alert — awaiting a dock drive.
