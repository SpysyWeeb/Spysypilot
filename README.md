...
- ⚠️ **[Smooth Stops](https://github.com/SpysyWeeb/Spysypilot/tree/smooth-stops)** — radard's low-speed lead gates: an unconfirmed radar-only lead needs ~1 s of track age and a distance past 0.6 s of travel; the landing and the stop bit's timing are BLoTv3's, and LongControl is upstream's again since the thin handoff was retired 2026-09-26 &nbsp;*(in progress; awaiting owner field validation)*
