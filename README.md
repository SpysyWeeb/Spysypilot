...
**Status: phase 1 field-validated 2026-08-29; phase 2 steps 2 and 3 merged 2026-08-29 — step 3 (modeld's
curvature preview is the rack path; the immediate target is the scalar itself) and the path-compile cost fix
(`RackTrajectoryController.update` 4.0 → 1.75 ms per frame on the device) await field validation.** `controlsd`
