...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — future-path, actuator-aware Hyundai torque control with (409, 4, 7) command/safety limits, post-stall EPS breakaway relief that preserves initial turn-in authority, and a committed-handoff cap that removes only stale old-direction command &nbsp;*(personal idea)*
