...
- ⚠️ **[Better lateral tune v3 (BLaTv3)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaTv3)** — ground-up rewrite of the Palisade rack-trajectory controller in the upstream controller shape (`LatControlRack`, opendbc firmware flag, own log union arm, warm stock fallback), designed from a written failure-mode catalog: the model stays path authority, a scheduled preview never overrides the near target, and the static comfort-envelope tables give way to learned rack-effort surfaces &nbsp;*(personal idea; phases 1–2 field-validated 2026-08-29/30; phase 3 in progress — steps 1–7 field-validated through 2026-09-05, step 7 (execution shaping: highway feedforward taper, reference-filter rate consistency) driven clean on route 54; step 8 (planner anticipation + feedforward headroom cap) pinned; preview-flicker units fix ✅ field-validated 2026-09-10 on route 00000062; rate-source fix (wheel rate from the angle, FM3.8 as written) ✅ field-validated 2026-09-10 on routes 00000063/64 and on the highway 2026-09-11, route 00000069: near:wheel at 0.55–0.8 Hz 1.46 at 112–144 km/h against 1.59 pre-fix and 1.71 on the same car two days earlier; resonance fix (one tracker law, k 0.925, 0.3 s response, the served rate as the served position's own motion) ✅ field-validated 2026-09-11 on route 0000006a: the plan stage at 0.55–0.8 Hz 0.92–1.01 against 1.00–1.25 before, near:wheel 1.20 at 112–144 km/h against 1.46 and stock's 0.88, owner: "drove better"; hygiene batch (inline torque rules named, content faults held, R7 across the hand-over, preview grid pinned) merged 2026-09-11 and ✅ regression-checked on routes 0000006b/6e: byte-identical replay against the previous controller, no fault or hand-over frame occurred; hold top-up in two regimes (hold effort at and below 10 m/s, integral action in P's units from 15 m/s) merged 2026-09-11 and ✅ field-validated on route 0000006f: its share of P at highway speed 0.68 → 0.14 in the resonance band, steps unchanged, owner: "looks good"; preview scheduler rewrite (one scheduler, physical units, no confidence gate, no 40 m cap, a continuous served preview) merged 2026-09-11 and ✅ field-validated 2026-09-12 on route 00000070: the preview open 1.5–1.7 s at every speed against 0.03–0.55, near:wheel at 112–144 km/h 0.89 against 1.20 and the stock reference 0.88, torque content −12–30 % with the road held fixed, owner: "drive felt fine, I think I did notice the lag change"; ❌ reverted 2026-09-12 after routes 00000071/72 on winding roads — owner: "lazy, wanders in the lane", the calm settings were open on bends; the controller is back to the route-0000006f state while the calm is redesigned to follow the horizon's steadiness rather than its consistency)*
