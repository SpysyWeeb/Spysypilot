...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — restored to controller v14's future-path and actuator-aware Hyundai torque-control baseline with (409, 4, 7) command/safety limits and EPS-motion-gated damping; the v15–v19 handoff, high-angle release, breakout, remembered-intent, and catch-up interventions are removed, and renewed low-speed field validation is pending &nbsp;*(personal idea)*
