...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — future-path, actuator-aware Hyundai torque control with (409, 4, 7) command/safety limits, controller v19's 200 ms evidence-gated catch-up pulse for extreme low-speed turn-in/unwind underperformance, signed wheel-rate recovery checks, post-stall EPS breakaway relief, and committed-handoff protection; route-98 replay and automated validation passed, while field validation remains pending &nbsp;*(personal idea)*
