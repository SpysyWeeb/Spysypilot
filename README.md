...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — controller v15 at `498d8d6d06` adds a scalar-anchored high-speed reference, one-replan blip quarantine, and an anchored-rate adapter while preserving the field-tested v14 path through 12 mph; all four frozen-route replay gates pass in route-audit commit `4aca096`, and Phase 1 remains in progress pending a field drive and explicit sign-off &nbsp;*(personal idea)*
