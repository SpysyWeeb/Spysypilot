...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — future-path, actuator-aware Hyundai torque control with (409, 4, 7) command/safety limits, post-stall EPS breakaway relief, a committed-handoff cap, and controller v18's in-progress present-demand-gated high-angle release plus rate-recovery-latched bounded EPS breakout assist; route-94/95 replay passed and field validation is pending &nbsp;*(personal idea)*
