...
- ⚠️ **[Better lateral tune (BLaT)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaT)** — restored to the field-tested controller v14 tree from rollback authority `5e533e3ec6` after v15 failed field feel and the v15.1 persistence candidate failed replay roughness gates; lateral work remains in progress pending another on-car check and explicit sign-off &nbsp;*(personal idea)*
