...
- ⚠️ **[Better lateral tune v2 (BLaTv2)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaTv2)** — v207 keeps the model scalar as the sole position authority while adding coherent plan-derived rack motion, event-based measured-rack breakaway, and slew-feasible future torque timing under Hyundai's exact 409/4/7 envelope; it remains in progress for field validation, with route bb showing substantially calmer 35–45 mph commands and full sharp-turn targets while post-takeover delivered replay remains explicitly unresolved; passive frozen-v14 shadow v10 provides the live A/B &nbsp;*(personal idea)*
