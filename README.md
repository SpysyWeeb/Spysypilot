...
- ⚠️ **[Better lateral tune v2 (BLaTv2)](https://github.com/SpysyWeeb/Spysypilot/tree/BLaTv2)** — inverse-EPS LQI controller v203 selects kinetic feedforward 0.03 and curvature tolerance 0.00091683 1/m from the b7 response surface while retaining 0.09 static breakaway/observer bounds; its owner-authorized staged-field deviations are raw burst 28.89/s vs v14 26.08/s and unavailable >20 m/s stability coverage on b7 (18.43 m/s maximum), both recorded as failed gates rather than passes; passive v14 shadow v8 retains CTRL_LOW/FIFO but roams cores 0–4 after CPU-4 pinning reduced it to ~32 Hz; invalid LQI output retains the tested `commIssue` hold/decay/soft-disable contract &nbsp;*(personal idea)*
